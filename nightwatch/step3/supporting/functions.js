...
/**
 * Looks over the UI to make sure needed elements are visible and displaying the right text.
 * 
...
const uiChecker = browser => {
    ...
    //check buttons for displayed text
...
/**keeps track of the number on the calculator display screen based on button clicks */
var currentDisplay = '0'
/**
 * Clicks a button and checks that the resulting display is correct.
 * If the button clicked is a special operator (=, %, +/-), we wont check the result in this function.
 * 
 * @param {object} browser  an object provided by NightwatchJS which hooks into the test browser
 * @param {string} button  the key of the button to click (corresponding to the keys in selectors.js)
 */
